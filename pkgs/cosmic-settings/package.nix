...
rustPlatform.buildRustPackage {
  ...
  version = "1.0.0-alpha.2-unstable-2024-10-08";

  src = fetchFromGitHub {
    owner = "pop-os";
    repo = "cosmic-settings";
    rev = "d761d763d517677c4397d9a0c04ecfdb4a69e451";
    hash = "sha256-UlREhlIpFVAUAQgXmDUYn3fWvSJgHEI6d/b41cp18mI=";
  };
  ...
  cargoLock = {
    ...
    outputHashes = {
      ...
      "cosmic-comp-config-0.1.0" = "sha256-RXpDLwrIffBy57NL2Xms9qPC8Z6kW8NGwzsIm1OgLUk=";
